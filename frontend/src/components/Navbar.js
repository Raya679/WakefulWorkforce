  ...
  return (
    <nav className='sticky z-10 w-full top-0'>
      <div className='flex items-center px-2 py-2 font-bold bg-slate-900 text-white'>
        ...
        <Link to="/" className='mx-7 text-1xl  font-bold px-3 py-2 hover:bg-cyan-400 hover:text-slate-900 rounded-[26px] transition duration-200 ease-out hover:ease-in'>HOME</Link>
