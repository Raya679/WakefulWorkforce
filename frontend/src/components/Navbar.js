  ...
  return (
    <nav className='sticky top-0'>
      <div className='flex items-center px-2 py-2 font-bold bg-slate-900 text-white'>
        ...
        <Link to="/" className='mx-10 text-1xl font-light hover:font-bold '>HOME</Link>
        <Link to="/aboutus" className='mx-10 text-1xl font-light hover:font-bold  '>ABOUT US</Link>
        <Link to="/contactus" className='mx-10 text-1xl font-light hover:font-bold '>CONTACT US</Link>
        {isAuthenticated ?
